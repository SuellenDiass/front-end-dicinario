// Quando não tem evento , click de botao, será nescessário que a função seja carregada automaticamente dentro do projeto chamando a função fora da função da forma abaixo.
// O uso de chaves duplas{{}} é usada quando há mais de uma informação usada dentro da variavel
//
...
//  Foram feitas algumas mudanças no HTML do projeto, toda a estrutura da section que estava lá vai ser inserida pelo innerHTML, então ela não precisa mais ficar lá.
// O innerHTML insere códigos HTML, mas lembre-se que é preciso indicar onde esse código precisa ser inserido lá no HTML.
...
// foi substituido pelo codigo acima
    /*console.log(
      (bio +=
        " " +
        "Nome: " +
        ...
        " " +
        "Minibio: " +
        biografias[bio].descricao + " " + "Citação: " + biografias[bio].citacao)
    );*/
  }
}
carregaDicionario();
